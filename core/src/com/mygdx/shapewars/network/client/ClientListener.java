    ...
    public void received(Connection connection, Object object) {
        if (object instanceof GameResponse) {
            for (int i = 0; i < model.engine.getEntities().size(); i++) {
                ...
                // update position
                PositionComponent[] positionComponents = ((GameResponse) object).positionComponents;
                ...
                // update velocity
                VelocityComponent[] velocityComponents = ((GameResponse) object).velocityComponents;
                ...
                // update health
                HealthComponent[] healthComponents = ((GameResponse) object).healthComponents;
